...
public class LongBow extends Item implements Weapon {
    private Integer attackDamage;
    private final Integer levelRequirement;
    private final Boolean isOneHanded;

    public LongBow(Integer value, Integer weight, Integer attackDamage, Integer levelRequirement, Boolean isOneHanded) {
        super(value, weight);
