...
private Double condition;
    ...
    public ShortSword(Integer value, Integer weight, Integer attackDamage, Integer levelRequirement, Boolean isOneHanded, Integer durability, Double condition) {
        super(value, weight);
    ...
    public static ShortSword makeDefaultShortSword() {
        return new ShortSword(30, 15, 5, 1, true, 20, 100.0);
    }
