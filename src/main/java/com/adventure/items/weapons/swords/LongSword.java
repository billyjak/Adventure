...
public class LongSword extends Item implements Weapon {
    ...
    public LongSword(Integer value, Integer weight, Integer attackDamage, Integer levelRequirement, Boolean isOneHanded, Integer durability, Double condition) {
        super(value, weight);
    ...
    public static ShortSword makeDefaultShortSword() {
        return new ShortSword(40, 20, 7, 3, true, 20, 100.0);
    }
